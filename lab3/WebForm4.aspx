<%@ Page Title="Изменить запись" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="WebApplication_lr3.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server" method="post">
        ...
        <asp:Button ID="submit" OnClick="submit_Click" CssClass="btn btn-primary" text="Изменить" runat="server" />
    </form>
